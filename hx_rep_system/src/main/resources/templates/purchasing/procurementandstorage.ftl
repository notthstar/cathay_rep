...
<#--<li class="active"><a href="procurementandstorage.ftl"><i class="fa fa-toggle-off"></i>采购入库</a>-->
<#--</li>-->
...
<div class="content-inner">
    ...
    <div class="breadcrumb-holder container-fluid">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">采购入库</li>
        </ul>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="subForm" action="/showpurchasesystem">
                                <table>
                                    <tr>
                            ...
                            <div style="margin-top: 20px;">
                                <table class="table table-hover text-center">
                                    ...
                                    <form action="/deletePurchaseSystem" method="post" id="deleteIds">
                                    <#list showall as all>
                                    <tr>
                                        ...
                                        <td style="display: flex; justify-content: space-between;">
                                            ...
                                            <a href="/deletePurchaseSystem?cElt=${all.id}" style="color: red;">
