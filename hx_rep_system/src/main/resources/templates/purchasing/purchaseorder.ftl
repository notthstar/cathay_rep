...
<#--<!--下拉列表1&ndash;&gt;-->
<#--<li><a href="#retailmanagement" aria-expanded="false" data-toggle="collapse" id="retailadministration">-->
<#--<i class="fa fa-podcast"></i>零售管理 </a>-->
...
<#--</li>-->
<#--<!--下拉列表2&ndash;&gt;-->
<#--<li><a href="#purchasing" aria-expanded="false" data-toggle="collapse"-->
<#--id="purchasingmanagemen"> <i class="fa fa-bookmark-o"></i>采购管理</a>-->
<#--<ul class="collapse list-unstyled" id="purchasing">-->
<#--<li class="active"><a href="purchaseorder.ftl"><i class="fa fa-toggle-off"></i>采购订单</a></li>-->
<#--<li><a href="procurementandstorage.ftl"><i class="fa fa-toggle-off"></i>采购入库</a></li>-->
<#--<li><a href="purchasereturn.ftl"><i class="fa fa-toggle-off"></i>采购退货</a></li>-->
<#--</ul>-->
<#--</li>-->
<#--<!--下拉列表3&ndash;&gt;-->
<#--<li><a href="#salesmanagement" aria-expanded="false" data-toggle="collapse"> <i-->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="subForm" action="/showDepothadInfo" method="post">
                                <table>
                                    <tr>
                            ...
                            <div style="margin-top: 20px;">
                                <table class="table table-hover text-center">
                                    <tr class="text-bold">
                                        <td><input type="checkbox" title="全选" id="chElt" onclick="checkOrCancelAll()">
                                        </td>
                                        <td>操作</td>
                                        <td>供应商名称</td>
                                        <td>单据编号</td>
                                    ...
                                    <form action="/deleteByIdInfo" method="post" id="deleteIds">
								<#list showall as all>
                                    <tr>
                                        <td><input type="checkbox" name="cElt"></td>
                                        <td style="display: flex; justify-content: space-between;">
                                            <a href="#"><i class="fa fa-list" title="查看"></i></a>
                                            <a href="#" style="color: green;"><i class="fa fa-pencil-square-o"
                                                                                 title="编辑"></i></a>
                                            <a href="/deleteByIdInfo?cElt=${all.id}" style="color: red;"><i class="fa fa-trash-o" title="删除"></i></a>
                                        </td>
                                        <td>${all.supplier}</td>
                                        <td>${all.number}</td>
                                        <td>${all.name}</td>
                            ...
                            <div style="display: flex;justify-content: flex-end;">
                                ...
                                <button class="btn btn-danger" title="删除" onclick="deleteBill()"><i
                                        class="fa fa-times"></i>
                                    删除
                                </button>&nbsp;
                        ...
                        <tr>
                            ...
                            <td width="345px">
                                <select name="" class="form-control">
                                    ...
                                    <#list allname as allname>
                                    <option value="${allname.id}">${allname.supplier}</option>
                                    </#list>
                                </select>
                            </td>
                            <td>单据日期：</td>
...
<!--新增供应商模态框-->
<div class="modal fade" role="dialog" tabindex="-1" aria-hidden="false" aria-labelledby="mymodalrigerth"
     data-backdrop="static" data-keyboard="true" id="rigerth">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="width: 878px;">
            <div class="modal-header">
						<span class="modal-title" id="mymodalriLabel">
                    ...
                    <table>
                        <tr>
                            <td style="width: 500px;">
                                <input type="text" class="form-control" name="supplier" placeholder="用户名">
                            </td>
                            <td style="width: 500px;">
                        ...
                        <tr>
                            <td style="width: 500px;">
                                <input type="text" class="form-control" name="beginNeedGet" placeholder="期初应收">
                            </td>
                            <td style="width: 500px;">
                                <input type="text" class="form-control" name="beginNeedPay" placeholder="期初应付">
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 500px;">
                        ...
                        <tr>
                            <td style="width: 500px;">
                                <input type="text" class="form-control" name="taxNum" placeholder="纳税人识别号">
                            </td>
                            <td style="width: 500px;">
                        ...
                        <tr>
                            <td style="width: 500px;">
                                <input type="text" class="form-control" name="bankName" placeholder="开户行">
                            </td>
                            <td style="width: 500px;">
                        ...
                        <tr>
                            <td style="width: 1000px;" colspan="2">
                                <textarea class="form-control" rows="2" name="description" placeholder="备注"></textarea>
                            </td>
                        </tr>
                    </table>
                    <div class="modal-footer">
